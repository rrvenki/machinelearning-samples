...
Namespace Common
	Public Module ConsoleHelper
		...
		Public Sub PrintRegressionMetrics(ByVal name As String, ByVal metrics As RegressionEvaluator.Result)
			Console.WriteLine($"*************************************************")
		...
		Public Sub PrintBinaryClassificationMetrics(ByVal name As String, ByVal metrics As BinaryClassifierEvaluator.Result)
			Console.WriteLine($"************************************************************")
		...
		Public Sub PrintMultiClassClassificationMetrics(ByVal name As String, ByVal metrics As MultiClassClassifierEvaluator.Result)
			Console.WriteLine($"************************************************************")
        ...
        Public Sub PrintMulticlassClassificationFoldsAverageMetrics(ByVal algorithmName As String,
            crossValResults() As (metrics As MultiClassClassifierEvaluator.Result, model As ITransformer, scoredTestData As IDataView))
		...
		Public Sub PrintClusteringMetrics(ByVal name As String, ByVal metrics As ClusteringEvaluator.Result)
			Console.WriteLine($"*************************************************")
		...
		Public Function PeekDataViewInConsole(Of TObservation As {Class, New})(ByVal mlContext As MLContext, ByVal dataView As IDataView, ByVal pipeline As IEstimator(Of ITransformer), Optional ByVal numberOfRows As Integer = 4) As List(Of TObservation)
