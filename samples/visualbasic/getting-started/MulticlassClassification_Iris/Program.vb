...
Public Module Program
    ...
    Friend Async Function TrainAsync() As Task(Of PredictionModel(Of IrisData, IrisPrediction))
        ...
        Dim pipeline = New LearningPipeline From {(New TextLoader(TrainDataPath)).CreateFrom(Of IrisData)(), New ColumnConcatenator("Features", "SepalLength", "SepalWidth", "PetalLength", "PetalWidth"), New StochasticDualCoordinateAscentClassifier()}
