...
Namespace ImageClassification.Model
	Public Module ModelHelpers
		...
		Public Function GetLabel(ByVal labels() As String, ByVal probs() As Single) As (String, Single)
			Dim max = probs.Max()
		...
		Public Iterator Function GetColumnNames(ByVal schema As Schema) As IEnumerable(Of String)
			For i As Integer = 0 To schema.ColumnCount - 1
				If Not MetadataUtils.IsHidden(schema, i) Then
