    ...
    Public Class Program
        Shared Sub Main(args() As String)
            ...
            Try
                ...
                Common.PeekDataViewInConsole(Of PivotObservation)(mlContext, pivotDataView, dataProcessPipeline, 10)
                Common.PeekVectorColumnDataInConsole(mlContext, "Features", pivotDataView, dataProcessPipeline, 10)
                ...
                Common.PrintClusteringMetrics(trainer.ToString(), metrics)

                ' STEP5: Save/persist the model as a .ZIP file
                modelBuilder.SaveModelAsFile(modelZip)

            Catch ex As Exception
                Common.ConsoleWriteException(ex.Message)
            End Try
