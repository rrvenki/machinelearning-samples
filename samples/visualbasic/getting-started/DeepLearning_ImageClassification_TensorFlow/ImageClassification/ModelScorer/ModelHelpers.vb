...
Namespace ImageClassification.ModelScorer
	Public Module ModelHelpers
		...
		Public Function GetBestLabel(ByVal labels() As String, ByVal probs() As Single) As (String, Single)
			Dim max = probs.Max()
			Dim index = probs.AsSpan().IndexOf(max)
			Return (labels(index),max)
		End Function

		Public Function ReadLabels(ByVal labelsLocation As String) As String()
