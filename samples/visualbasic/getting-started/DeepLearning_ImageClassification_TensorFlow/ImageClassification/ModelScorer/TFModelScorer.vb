...
Namespace ImageClassification.ModelScorer
    Public Class TFModelScorer
        ...
        Private Function LoadModel(dataLocation As String, imagesFolder As String, modelLocation As String) As PredictionFunction(Of ImageNetData, ImageNetPrediction)
        ...
        Protected Iterator Function PredictDataUsingModel(testLocation As String, imagesFolder As String, labelsLocation As String, model As PredictionFunction(Of ImageNetData, ImageNetPrediction)) As IEnumerable(Of ImageNetData)
