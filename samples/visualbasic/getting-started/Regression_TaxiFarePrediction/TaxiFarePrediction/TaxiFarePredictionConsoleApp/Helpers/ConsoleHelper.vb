...
Namespace Regression_TaxiFarePrediction.Helpers
    Public Module ConsoleHelper
        Public Function PeekDataViewInConsole(context As MLContext, dataView As IDataView, pipeline As EstimatorChain(Of ITransformer), Optional numberOfRows As Integer = 4) As List(Of TaxiTrip)
        ...
        Public Function PeekFeaturesColumnDataInConsole(columnName As String, mlcontext As MLContext, dataView As IDataView, pipeline As EstimatorChain(Of ITransformer), Optional numberOfRows As Integer = 4) As List(Of Single())
