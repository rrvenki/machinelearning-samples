...
Namespace CreditCardFraudDetection.Common
	Public Module ConsoleHelpers
		...
		Public Sub InspectData(ByVal env As LocalEnvironment, ByVal data As IDataView, ByVal records As Integer)
			ShowObservations(env, data, label:= True, count:= records)
			ShowObservations(env, data, label:= False, count:= records)
		End Sub

		Public Sub InspectScoredData(ByVal env As LocalEnvironment, ByVal data As IDataView, ByVal records As Integer)
			ShowPredictions(env, data, label:= True, count:= records)
			ShowPredictions(env, data, label:= False, count:= records)
		End Sub

		Public Sub ShowObservations(ByVal env As LocalEnvironment, ByVal data As IDataView, Optional ByVal label As Boolean = True, Optional ByVal count As Integer = 2)
		...
		Public Sub ShowPredictions(ByVal env As LocalEnvironment, ByVal data As IDataView, Optional ByVal label As Boolean = True, Optional ByVal count As Integer = 2)
